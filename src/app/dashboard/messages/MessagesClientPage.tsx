          ...
          {activeTab === 'correspondence' && (
            <div>
              ...
              <form action={handleSendMessage} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="inline-flex justify-center rounded-md border border-transparent bg-red-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-secondary-accent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Send Message
                </button>
              </form>
