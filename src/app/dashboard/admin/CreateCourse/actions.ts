...
export async function createClass(formData: FormData) {
  ...
  revalidatePath('/dashboard/admin/CreateCourse');
}
...
export async function updateClass(classId: number, formData: FormData) {
  ...
  revalidatePath('/dashboard/admin/CreateCourse');
  revalidatePath(`/dashboard/admin/CreateCourse/edit-class/${classId}`);
}
...
export async function updateLesson(lessonId: number, formData: FormData) {
  ...
  revalidatePath(`/dashboard/admin/CreateCourse/edit-lesson/${lessonId}`);
}
...
export async function requestEnrollment(userId: number, classId: number) {
  ...
  revalidatePath(`/dashboard/admin/CreateCourse/enrollment-requests`); // Revalidate admin requests page
  revalidatePath(`/dashboard/courses`); // Revalidate user class list
}
...
export async function acceptEnrollment(enrollmentId: number) {
  ...
  revalidatePath(`/dashboard/admin/CreateCourse/enrollment-requests`);
